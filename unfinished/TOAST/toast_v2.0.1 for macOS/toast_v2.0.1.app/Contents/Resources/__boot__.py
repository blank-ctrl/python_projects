...
_recipes_pil_prescript(['MspImagePlugin', 'DcxImagePlugin', 'CurImagePlugin', 'SunImagePlugin', 'TgaImagePlugin', 'JpegImagePlugin', 'FitsStubImagePlugin', 'TiffImagePlugin', 'FpxImagePlugin', 'FitsImagePlugin', 'MpegImagePlugin', 'GribStubImagePlugin', 'PpmImagePlugin', 'MpoImagePlugin', 'FliImagePlugin', 'XbmImagePlugin', 'WebPImagePlugin', 'SpiderImagePlugin', 'PcdImagePlugin', 'PcxImagePlugin', 'PsdImagePlugin', 'IcnsImagePlugin', 'WmfImagePlugin', 'SgiImagePlugin', 'IptcImagePlugin', 'XVThumbImagePlugin', 'ImImagePlugin', 'PdfImagePlugin', 'IcoImagePlugin', 'GbrImagePlugin', 'GifImagePlugin', 'EpsImagePlugin', 'DdsImagePlugin', 'BufrStubImagePlugin', 'XpmImagePlugin', 'QoiImagePlugin', 'Hdf5StubImagePlugin', 'MicImagePlugin', 'Jpeg2KImagePlugin', 'PngImagePlugin', 'BlpImagePlugin', 'PalmImagePlugin', 'McIdasImagePlugin', 'FtexImagePlugin', 'PixarImagePlugin', 'BmpImagePlugin', 'ImtImagePlugin'])
...
DEFAULT_SCRIPT='toast_v2.0.1.py'
SCRIPT_MAP={}
_run()
