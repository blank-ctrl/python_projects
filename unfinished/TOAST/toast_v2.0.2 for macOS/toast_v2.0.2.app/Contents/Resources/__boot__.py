...
_recipes_pil_prescript(['PsdImagePlugin', 'FliImagePlugin', 'PdfImagePlugin', 'Hdf5StubImagePlugin', 'DdsImagePlugin', 'IptcImagePlugin', 'MpoImagePlugin', 'PalmImagePlugin', 'SpiderImagePlugin', 'DcxImagePlugin', 'IcoImagePlugin', 'ImtImagePlugin', 'McIdasImagePlugin', 'FitsStubImagePlugin', 'Jpeg2KImagePlugin', 'QoiImagePlugin', 'MicImagePlugin', 'MspImagePlugin', 'GifImagePlugin', 'BlpImagePlugin', 'XpmImagePlugin', 'FpxImagePlugin', 'ImImagePlugin', 'SgiImagePlugin', 'IcnsImagePlugin', 'GbrImagePlugin', 'XVThumbImagePlugin', 'PcxImagePlugin', 'PcdImagePlugin', 'FtexImagePlugin', 'PpmImagePlugin', 'JpegImagePlugin', 'TiffImagePlugin', 'FitsImagePlugin', 'WmfImagePlugin', 'MpegImagePlugin', 'TgaImagePlugin', 'SunImagePlugin', 'PngImagePlugin', 'CurImagePlugin', 'EpsImagePlugin', 'WebPImagePlugin', 'BmpImagePlugin', 'PixarImagePlugin', 'GribStubImagePlugin', 'BufrStubImagePlugin', 'XbmImagePlugin'])
...
DEFAULT_SCRIPT='toast_v2.0.2.py'
SCRIPT_MAP={}
_run()
